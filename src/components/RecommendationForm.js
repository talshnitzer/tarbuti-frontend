      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={4}>
          ...
          <TextField
            ...
            error={
              ...
              Boolean(formik.errors.providerPhone)
            }
            helperText={
        ...
        <Grid item xs={12} sm={9}>
          ...
          <TextField
            ...
            error={
              formik.touched.priceRemarks && Boolean(formik.errors.priceRemarks)
            }
            helperText={
              formik.touched.priceRemarks && formik.errors.priceRemarks
            }
          />
        </Grid>
        <Grid item xs={12} sm={3}>
